            ...
            <BrowserRouter>
                <Routes>
                    <Route element={<><NavHeader questionNum={question.id} />
                        ...
                        <Route path="/"/>
                        <Route path="/questions/:questionId" element={<SingleQuestion question={question} answers={answers} voteUp={voteUp}/>}/>
                        <Route path="/questions/:questionId/addAnswer" element={<AnswerForm addAnswer={addAnswer} lastId={Math.max(...answers.map(ans => ans.id))}/>}/>
                        <Route path="/questions/:questionId/editAnswer/:answerId" element={<AnswerForm updateAnswer={updateAnswer}/>}/>
